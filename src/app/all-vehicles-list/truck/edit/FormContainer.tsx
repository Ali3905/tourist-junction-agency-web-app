...
import { truckFormFields } from "@/utils/FormFields"
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
  ...
  return (
    <div className='max-w-[1400px] mx-auto'>
      <h2 className='font-bold text-[26px] text-center'>Edit Truck Details</h2>
      <Form formFields={truckFormFields} handler={handleSubmitTruckForm} defaultValues={editData} />
    </div>
  );
};
