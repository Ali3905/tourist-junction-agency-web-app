...
const HolidayYatraCard = ({ data, onUpdate, onDelete }) => {
  const { tourName, mobNoOne, mobNoTwo, address, location, imageSrc } = data;
  return (
    <div className="relative max-w-sm rounded-lg overflow-hidden shadow-md hover:shadow-lg mt-6 transition-shadow duration-300">
      ...
      <div className="absolute top-2 right-2 space-x-2">
        ...
        <div className="p-4">
          ...
          <h2 className="font-semibold text-lg">Tour Name:{tourName}</h2>
          <p className="text-gray-600">Mob No:{mobNoOne}</p>
          <p className="text-gray-600">Mob No:{mobNoTwo}</p>
